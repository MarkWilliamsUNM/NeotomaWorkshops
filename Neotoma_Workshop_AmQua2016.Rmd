...
## Useful Websites
### Neotoma Resources
* This Exercise: <https://github.com/IceAgeEcologist/NeotomaWorkshops/blob/master/Neotoma_Workshop_AmQua2016.Rmd>
...
This is the API that interfaces between your web browser and Google's databases.  You can see I searched for the string “when did the quatnerary begin”, it is prefaced by “q=”. Google's servers know that when they are reading the URL everything followed by the hash sign (#) is part of a set of variables.
...
##### Walkthrough of APIs
1.	Site, Dataset, etc. (walk through each with examples)
2.	Base Tables 
